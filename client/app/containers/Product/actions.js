...
export const fetchStoreProduct = (slug) => {
    return async (dispatch, getState) => {
        ...
        try {
            ...
            const regularPrice = response.data.regularPrice
            const product = {
    ...
    return async (dispatch, getState) => {
        try {
            ...
            const response = await axios.get(
                `${API_URL}/product/list/brand/${slug}`
            )
    ...
    return async (dispatch, getState) => {
        try {
            const rules = {
                ...
                goldMemberPrice: 'required|numeric',
                platinumMemberPrice: 'required|numeric',
                taxable: 'required',
                image: 'required',
                brand: 'required',
            }
            ...
            const newProduct = {
                ...
                price: product.price,
                goldMemberPrice: product.goldMemberPrice,
                platinumMemberPrice: product.platinumMemberPrice,
            ...
            const { isValid, errors } = allFieldsValidation(newProduct, rules, {
                ...
                'required.goldMemberPrice': 'Price is required.',
                'required.platinumMemberPrice': 'Price is required.',
                'required.taxable': 'Taxable is required.',
                'required.image':
                    'Please upload files with jpg, jpeg, png format.',
